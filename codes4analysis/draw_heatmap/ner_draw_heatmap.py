...
if __name__ == '__main__':
    # result_dir = 'results/'
    result_dir = '../evaluation_results/ner-evaluation/'
    result_files = os.listdir(result_dir)
    dict_aided_diag_heatmap = {}
    new_corpus_name_dic = {'conll03':'co', 'notebn':'bn', 'notebc':'bc',
                            'notemz':'mz', 'notenw':'nw', 'notewb':'wb', 'notetc':'tc'}
    ...
    xsticks = ['XS','S','L','XL']
    ysticks = ['co','wb','tc','bc','mz','bn','nw']
    # attrs_names = ['MF-et', 'MF-tt', 'F-ent', 'F-tok', 'R-eLen', 'R-sLen','R-eDen','R-oov','R-tag']
    attrs_names = ['MF-et', 'MF-tt', 'F-ent', 'F-tok', 'R-eLen', 'R-sLen','R-eDen','R-oov']
    for attrs_name in attrs_names:
        ...
        #print mat
        out_fig = 'heatmap/'+attrs_name+'.png'
        fig, ax = plt.subplots()
        im, cbar = heatmap(attrs_name,np.array(attr_corpus_4values_list), xsticks, ysticks, ax=ax, vmin=-0.03, vmax=0.03,
                           cmap='RdBu')  # cmap ="PiYG"
